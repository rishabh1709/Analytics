#Data Structures
#bookmark by text using ----
#Vectors----
v1 = c('A', 'B','C')   #create a vector
v1   #print the vector
(v2 = c(1,2,3)) #round brackets extra ,create and print
v2
class(v2)
...
v1[v1%in%v7]    #find values in vector v1 and also in v7 i.e commom ones
v7[!v7%in%v1]
v7[v7%in%v1]
v1
v1['A']  #wrong/ error
...
(taxila=1:3)
names(taxila)=c('den','Geeta','daniel')
names(taxila)
set.seed(1234)
sample(1:10)
v8 #see headings
...
(matrix1 = matrix(1:24, ncol=4,byrow=T))
length(1:24)
